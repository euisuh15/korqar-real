...
<div id="policy-agree-box">
    <div class="agreebox">
        ...
        <h4 class="ctit2 mt0 mb0">1. 수집하는 개인정보 항목</h4>
        - 개인정보 수집항목 (회원가입) : 회원 이름, 이메일 주소, 로그인 ID, 패스워드
        - 개인정보 수집항목 (쿠키 등을 통한 자동 수집) : 접속IP, 서비스 이용 기록, OS정보, 접속 Device

        <h4 class="ctit2 mt0 mb0">2. 개인정보의 수집 및 이용목적</h4>
        회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
        1. 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 컨텐츠 제공, 본인인증
        2. 회원 관리 : 회원제 서비스 이용에 따른 본인확인, 개인식별, 불량회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인
        3. 마케팅 및 광고에 활용 : 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계

        <h4 class="ctit2 mt0 mb0">3. 개인정보의 보유 및 이용기간</h4>
        ...
        <h4 class="ctit2 mt0 mb0">4. 개인정보의 파기절차 및 방법</h4>
        회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.
        1. 파기절차 : 회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어집니다. 별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 보유되어지는 이외의 다른 목적으로 이용되지 않습니다.
        2. 파기방법 : 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.

        <h4 class="ctit2 mt0 mb0">5. 개인정보 제공</h4>
        ...
        <h4 class="ctit2 mt0 mb0">7. 이용자 및 법정대리인의 권리와 그 행사방법</h4>
        이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다.
        이용자들의 개인정보 조회,수정을 위해서는 ‘개인정보변경’(또는 ‘회원정보수정’ 등)을 가입해지(동의철회)를 위해서는 “회원탈퇴”를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 혹은 개인정보관리책임자에게 서면 또는 이메일로 연락하시면 지체없이 조치하겠습니다.
        ...
        <h4 class="ctit2 mt0 mb0">8. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</h4>
        ...
        <h4 class="ctit2 mt0 mb0">9. 개인정보에 관한 민원서비스</h4>
